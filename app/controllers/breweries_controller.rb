class BreweriesController < ApplicationController
  ...
  def authenticate
    admin_accounts = { pekka: "beer", arto: "foobaar", matti: "ittam", vilma: "kangas" }
    authenticate_or_request_with_http_basic do |username, password|
      raise "Wrong username or password" unless admin_accounts.key?(username.to_sym)

      raise "Wrong username or password" unless admin_accounts[username.to_sym] == password
