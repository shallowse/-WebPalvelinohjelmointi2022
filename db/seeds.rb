...
user_1 = User.find(1)
(1..beer_clubs).each do |i|
  bc = BeerClub.create! name: "CLUB#{i}", founded: 2010, city: 'Helsinki'
  bc.members << user_1
  bc.memberships.find_by(user_id: user_1.id).update_attribute(:confirmed, true)
end
